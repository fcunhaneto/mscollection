...
class ViewMovieSearchUrl(QMdiSubWindow):
    def __init__(self, main):
        ...
        """
        super(ViewMovieSearchUrl, self).__init__()
    ...
    def set_table(self, movies):
        ...
        for movie in movies:
            ...
            self.table.setItem(self.rows, 2, QTableWidgetItem(movie.search_url))

            date = "{:%d/%m/%Y}".format(movie.new_edit)
