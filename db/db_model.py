...
class Media(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.media_s, self.name)
...
class Actor(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.actor_s, self.name)
...
class Character(Base):
    ...
    def __repr__(self):
        '<{0} {1}>'.format(texts.character_s, self.name)
...
class Category(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.category_s, self.name)
...
class Director(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.director_s, self.name)
...
class Box(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.box, self.name)
...
class MovieCast(Base):
    ...
    order = Column(Integer, nullable=False, default=1000000000)
...
class Movie(Base):
    ...
    def __repr__(self):
        return '<{0} {1} - {2}>'.format(texts.movie_s, self.name, self.year)
...
class Creator(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format(texts.creator_s, self.name)
...
class Season(Base):
    ...
    def __repr__(self):
        return '<{0} {1}>'.format('Temporada', self.season_num)
